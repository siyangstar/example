...
public class CommentAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (Integer.valueOf(comment.replyCount) > 2 && comment.reply.size() > 2) {
            ...
            replay1.setSpan(new ForegroundColorSpan(0xff39B44A), 0,
                    (comment.reply.get(0).nickname + "：").length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
            ...
            replay2.setSpan(new ForegroundColorSpan(0xff39B44A), 0,
                    (comment.reply.get(1).nickname + "：").length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
            ...
            replay3.setSpan(new ForegroundColorSpan(0xff39B44A), 0,
                    (comment.reply.get(2).nickname + "：").length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
